...
begin
	...
	def draw_menu(menu, active_index=nil)
	  ["Get started with new key.", "List keys.", "Import and export keys.", "Delete keys.", "Trust a key.",\
	   "Quick encrypt.", "Encrypt with name.",\
     "Quick decrypt.", "Decrypt with name.", "Terminal decrypt.", "Encrypt file for e-mail and web.",\
     "Create or verify signature file."].each_with_index do |element, index|
	  # "w" for word array
